            ...
            
            {
              user && user.email === "nicolasgfalabella@gmail.com" && ( 
                ...
                <Link to={"/createItem"}>
                 ...
                 <p className='px-4 py-2 flex items-center gap-3 cursor-pointer hover:bg-slate-100 transition-all duration-100 ease-in-out text-textColor text-base' onClick = { () => setIsMenu(false)}> Agregar Producto <MdAdd />
                 </p>
              ...
              <p className='px-4 py-2 flex items-center gap-3 cursor-pointer hover:bg-slate-100 transition-all duration-100 ease-in-out text-textColor text-base' onClick={logout}> Salir <MdLogout /></p>
        ...
        <div className='relative'>
          ...
          <motion.img whileTap={{scale : 0.6}}
            ...
            
            {
              user && user.email === "nicolasgfalabella@gmail.com" && ( 
                ...
                onClick = { () => setIsMenu(false)} > Agregar Producto <MdAdd />
                </p>
          ...
          <ul className='flex flex-col'>
            ...
            <p className='m-2 p-2 rounded-md shadow-md flex items-center justify-center bg-gray-200 gap-3 cursor-pointer hover:bg-slate-300 transition-all duration-100 ease-in-out text-textColor text-base'
              onClick={logout}> Salir <MdLogout /></p>
